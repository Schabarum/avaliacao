...
const
  cSQL =
    'INSERT INTO MODELO (ID_MODELO, DESCRICAO, LANCAMENTO, ID_MARCA) ' +
    ' VALUES (%0:d, %1:s, %2:s, %3:d)';
begin
  inherited;
    TConnection.New
    .InserirDadosBD(Format(cSQL, [100, QuotedStr('Montana'), QuotedStr('2023-01-01'), 3]))
    .InserirDadosBD(Format(cSQL, [101, QuotedStr('Maverick'), QuotedStr('2022-01-01'), 6]))
    .InserirDadosBD(Format(cSQL, [102, QuotedStr('Corolla Cross Hybrid'), QuotedStr('2022-01-01'), 7]))
    .InserirDadosBD(Format(cSQL, [103, QuotedStr('BMW iX'), QuotedStr('2022-01-01'), 14]))
    .InserirDadosBD(Format(cSQL, [104, QuotedStr('ID. Buzz'), QuotedStr('2022-01-01'), 4]));
